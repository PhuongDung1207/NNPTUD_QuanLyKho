...
const batchLotStatuses = ["available", "blocked", "expired", "damaged"];
...
const productListRules = [
  ...
  query("limit").optional({ values: "falsy" }).isInt({ min: 1, max: 500 }).withMessage("limit must be between 1 and 500"),
